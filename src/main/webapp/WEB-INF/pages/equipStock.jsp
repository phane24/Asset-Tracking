...
function getClassItems()
{
	...
	$.ajax({
        ...
        datatype : "json",
        data:{"classSelected":selectedClass,"categorySelected":"Equipments"},
...
function changeCat(category) {
	if(category=="ItemType"){
    	...
    	document.getElementById("equipment").innerHTML = catOptions;
	...
	if(category=="ItemName"){
    	...
    	document.getElementById("equipName").innerHTML = catOptions;
        $("select option:contains('Select')").attr("disabled","disabled");
...
{
	var selectedClass=$('#classType').val();
	var selectedType=$('#equipment').val();
	...
	$.ajax({
        ...
        contentType: 'application/json',
        datatype : "json",
        data:{"selectedType":selectedType,"selectedClass":selectedClass,"selectedCategory":"Equipments"},
        success:function(data1) {
...
function getmodelTypes()
{
	...
	$.ajax({
        ...
        contentType: 'application/json',
        datatype : "json",
        data:{"selectedType":selectedType,"selectedClass":selectedClass,"selectedCategory":"Equipments","selectedModel":selectedModel},
        success:function(data1) {
        	itemsArr = JSON.parse(data1);
        	changeCat("modelNum");
        //	alert(itemsArr);
...
function gestockinhand()
{
	...
	var selectedClass=$('#classType').val();
	var selectedAsset=$('#equipment').val();
...
function fetchStocksData()
{
	...
	$.ajax({
        type:"get",
        url:"fetchEquipmentStocksData",
        contentType: 'application/json',
        datatype : "json",
        data:{"selectedClass":selectedClass,"selectedAsset":selectedAsset,"selectedassetName":selectedassetName,"selectedModel":selectedModel},
        success:function(data1) {
        	itemsArr = JSON.parse(data1);
		...
		$('#equipDesc').val(itemsArr[0].equipDesc);
...
function update_data()
{
	...
	var selectedassetName=$('#equipName').val();
	var selectedModel = $('#modelNum').val();
	var selectedassetDesc = $('#equipDesc').val();
	...
	$.ajax({
        type:"get",
        url:"updateEquipmentStocksData",
        contentType: 'application/json',
        datatype : "json",
        data:{"selectedClass":selectedClass,"selectedAsset":selectedAsset,"selectedassetName":selectedassetName,"selectedModel":selectedModel,"selectedassetDesc":selectedassetDesc,"selectedvendorName":selectedvendorName,"selecteditemPrice":selecteditemPrice,"selecteddelNorms":selecteddelNorms,"selectedorgStock":selectedorgStock,"selectedstockInHand":selectedstockInHand,"selectedstockInHandDate":selectedstockInHandDate,"selectedmanufactureDate":selectedmanufactureDate,"selectedexpiryDate":selectedexpiryDate,"selectedId":selectedId},
        success:function(data1) {
        	alert(data1);
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
		 ...
		 <!-- custom board-->
        <form:form action="addEquipStock" method="post" modelAttribute="EquipStock" class="forms-sample">
       
		 <form:hidden path="id"/>
		       <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                     <h4 class="card-title" style="color:darkgrey;font-size:1.845rem;"><center>Equipments Stock</center></h4>
                  ...
                  <p class="card-description">
                    ...
                    <div class="form-group row">
                      <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Select Eqiupment</label>
                      <div class="col-sm-9">
						<form:select id="equipment" class="form-control" path="equipment" onchange="getCategoryTypes()"/>              
					  </div>
                    </div>
                    
                	<div class="form-group row">
                      <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Select Equipment Name</label>
                      <div class="col-sm-9">
						<form:select id="equipName" class="form-control" path="equipName" onclick="getmodelTypes();"/>              
					  </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
						<form:textarea path="equipDesc" id="equipDesc" rows = "3" cols = "20" class="form-control" />              
					  </div>
                    </div>
                   ...
                   <!--  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
						<form:input id="vendorName" class="form-control" path="vendorName" onkeyup="this.value = this.value.toUpperCase();" />              
					  </div>
                    </div>-->
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
						<form:input type="text" id="itemPrice" name="itemPrice" placeholder="Item Price" value=""  path="itemPrice" onkeypress="return allowOnlyNumbers(event)" class="form-control"/>
						 </div>
                    </div>
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                      ...
                      <div class="col-sm-9">
						<form:input type="date" id="manufactureDate" placeholder="mm/dd/yyyy" name="manufactureDate"  path="manufactureDate" class="form-control"/><input type="hidden" id="primarykey" max="9999-12-31"/>
