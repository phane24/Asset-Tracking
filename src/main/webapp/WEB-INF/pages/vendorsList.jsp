...
<!--<c:out value="${vendorsList}"></c:out>

alert("${vendorsList}");-->

 <h4 class="card-title" style="color:darkgrey;font-size:1.845rem;"><center>Vendors List</center></h4>
		...
		<table border="1">
			<tr>
				...
				<th>Class A Assets</th>	 -->
				 <th>Class B Assets</th>	
				<th>Class C Assets</th>	
				<th>Class A Equips</th>	
				<th>Class B Equips</th>	
				<th>Class C Equips</th>	 
			...
			<c:forEach var="vendor" items="${vendorsList}"> 
				<tr>
					...
					<td>${vendor.categoryClass }</td>
					<td>${vendor.classAAssets }</td> --%>
					 <td>${vendor.classBAssets }</td>
					<td>${vendor.classCAssets }</td>
					<td>${vendor.classAEquips }</td>
					<td>${vendor.classBEquips }</td>
					<td>${vendor.classCEquips }</td> 
				</tr>
			</c:forEach>
		</table>
</div>
