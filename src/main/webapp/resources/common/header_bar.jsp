...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo" href="homePage"><img style="width:180px;height:45px;" src='<c:url value="/resources/images/logo.svg" />' alt="logo"></a>
          <a class="navbar-brand brand-logo-mini" href="homePage"><img src='<c:url value="/resources/images/logo-mini.svg" />' alt="logo"></a>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <!-- <img src='<c:url value="/resources/images/faces/profileImg.jpg"/>' alt="profile"/>-->
