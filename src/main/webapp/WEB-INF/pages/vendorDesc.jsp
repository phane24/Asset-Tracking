 ...
 <table align="center">
  ...
  <article>
    ...
    <div class="text">
      ...
      <button onclick="window.location.href = 'newVendor';" style="background-color:#009ca6">GO</button>
    </div>
  </article>
  ...
  <article>
    ...
    <div class="text">
      ...
      <button onclick="window.location.href = 'newVendorSupplier';" style="background-color:#009ca6">GO</button>
    </div>
  </article>
   ...
   <!--  <article>
    ...
    <div class="text">
      ...
      <button onclick="window.location.href = 'newVendorsList';" style="background-color:#009ca6">GO</button>
    </div>
  </article>
  -->
