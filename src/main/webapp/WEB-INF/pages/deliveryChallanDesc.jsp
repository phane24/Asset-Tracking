...
<body>
 ...
 <table align="center">
  ...
  <article>
    ...
    <div class="text">
      <h3>Vendor DeliveryChallan</h3>
     
      <button onclick="window.location.href = 'newVendorDC';" style="background-color:#009ca6">GO</button>
    </div>
  </article>
  ...
  <article>
    ...
    <div class="text">
      <h3>Warehouse DeliveryChallan</h3>
   
      <button onclick="window.location.href = 'newWarehouseDC';" style="background-color:#009ca6">GO</button>
    </div>
  </article>
